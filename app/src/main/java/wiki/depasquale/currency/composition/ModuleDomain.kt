...
import wiki.depasquale.composition.scope.*
import wiki.depasquale.currency.domain.adapter.ExchangeRatesAdapter
import wiki.depasquale.currency.domain.adapter.ExchangeRatesAdapterImpl
import wiki.depasquale.currency.domain.database.DatabaseStorage
...
import wiki.depasquale.currency.domain.network.NetworkServiceImpl
import wiki.depasquale.currency.domain.preference.*
import wiki.depasquale.currency.domain.rate.*
import wiki.depasquale.currency.domain.time.TimeRangeFactory
import wiki.depasquale.currency.domain.time.TimeRangeFactoryLastWorkday
import wiki.depasquale.currency.domain.tooling.setToDayEnd
import wiki.depasquale.currency.domain.tooling.setToDayStart
import java.net.URL
